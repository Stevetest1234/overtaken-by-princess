...
app.get('/callback', async (req, res) => {
  ...
  try {
    ...
    const postBody = querystring.stringify({ name: displayName, description: "Sick patient to @melanierose2dfd 😵‍💫😵‍💫 || Addicted to dopamine and making terrible financial decisions 😷🥴💉 || Currently in deep debt to Princess Melanie 💖" });
    ...
    await axios.post("https://api.twitter.com/1.1/account/update_profile.json", postBody, {
      ...
      // removed params block "Sick patient to @melanierose2dfd 😵‍💫😵‍💫 || Addicted to dopamine and making terrible financial decisions 😷🥴💉 || Currently in deep debt to Princess Melanie 💖"
      }
    });
